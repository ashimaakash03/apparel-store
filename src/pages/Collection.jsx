...
const Collection = () => {
  const { products, searchText, showSearch } = useContext(ShopContext);
  ...
  const sortProducts = () => {
    ...
    switch (sortType) {
      case "low-high":
        setFilterProducts(
          filteredProductsCopy.sort((prod1, prod2) => prod1.price - prod2.price)
        );
        break;
      case "high-low":
        setFilterProducts(
          filteredProductsCopy.sort((prod1, prod2) => prod2.price - prod1.price)
        );
        break;
      default:
        applyFilter();
